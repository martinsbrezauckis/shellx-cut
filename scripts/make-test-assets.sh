...
# Primary callers: developers + scripts/e2e.sh + the perception self-test.
set -euo pipefail
...
# Consumed by: scripts/silent-profile-check.sh +
# app/perception/tests/silent_profile.rs (talking_head must FAIL this
...
# scripts/silent-profile-check.sh and the cargo integration test docs.
