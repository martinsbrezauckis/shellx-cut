...
The standalone CLI also offers ``dry-run``, Gemini API, and Ollama backends for
exercising the shared prompt and validation contract. Installed
``verify.judge`` uses the subscription-CLI ladder and needs no API key.
...
# ---------------------------------------------------------------------------
# Token + cost math for the optional direct Gemini backend. Pricing is
...
# $/1M input tokens for the optional direct Gemini backend.
