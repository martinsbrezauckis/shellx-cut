...
pub use ops::{Actor, ActorKind, InverseOp, OpEffect, OpLog, OpRecord, OpStatus};
pub use rebase::{
...
pub use store::{
    ...
    AtomicMediaInsertPlanResult, ProjectStore,
};
pub use types::{
...
mod tests {
    ...
    /// Smoke: op-log append + read_since round-trip on disk.
    #[test]
    fn oplog_roundtrip() {
        ...
        assert!(log.read_since(Some("op_000001")).unwrap().is_empty());
    }
