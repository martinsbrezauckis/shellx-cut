        ...
        Err(error) => match error.termination() {
            ...
            Some(ProcessTermination::Cancelled(reason)) => {
                return json!({
                    "schema": "shellx-cut/generate-plan/1",
                    "status": "error",
                    "reason": format!("generate prompt adapter cancelled ({})", reason.label()),
                    "plan": Value::Null,
                    "warnings": [],
                })
            }
            None => {
                return json!({
                    "schema": "shellx-cut/generate-plan/1",
                    "status": "error",
                    "reason": format!("generate prompt adapter io error: {error}"),
                    "plan": Value::Null,
                    "warnings": [],
                })
            }
        ...
        Err(error) => match error.termination() {
            ...
            Some(ProcessTermination::Cancelled(reason)) => {
                return json!({
                    "schema": "shellx-cut/generate-storyboard-result/1",
                    "status": "error",
                    "reason": format!("generate storyboard adapter cancelled ({})", reason.label()),
                    "storyboard": Value::Null,
                    "questions": [],
                    "warnings": [],
                })
            ...
            None => {
                return json!({
                    "schema": "shellx-cut/generate-storyboard-result/1",
                    "status": "error",
                    "reason": format!("generate storyboard adapter io error: {error}"),
                    "storyboard": Value::Null,
                    "questions": [],
                    "warnings": [],
                })
