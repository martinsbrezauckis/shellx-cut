...
fn bake_local(
    ...
    let out =
        crate::dispatch::run_bounded_foreground_command(&mut cmd, "matte runner").map_err(|e| {
            CutError::new(
            error_codes::IO,
...
fn bake_matanyone(
    ...
    command
        ...
        .arg("--max-size")
        .arg(max_size);
    let out = crate::dispatch::run_bounded_foreground_command(&mut command, "MatAnyone runner")
        .map_err(|e| {
            CutError::new(
                error_codes::IO,
