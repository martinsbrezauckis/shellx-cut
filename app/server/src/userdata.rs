...
/// temp dir — a bare `cargo test` run used to append THOUSANDS of tempdir
/// project entries into the developer's real `~/.shellx-cut/projects.json`
/// (3.7k found; tests must never touch real user state.
