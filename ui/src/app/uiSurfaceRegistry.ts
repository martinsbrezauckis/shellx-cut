...
export const UI_SURFACES = [
  ...
  surface('settings-health-recovery', 'Health and recovery settings', 'overlay', '[data-cut-settings-body="health-recovery"]', 'Settings > Health & recovery', { kind: 'settings', category: 'health-recovery' }),
