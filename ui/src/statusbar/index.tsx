...
export default function StatusBar({ project, receipts, playheadMs, selectedClipIds, opsCount, clipboardNotice, doctor, onOpenEnvironment }: StatusBarProps) {
  ...
  // Real connected endpoint, not an assumed default — cutd binds --addr
  // (e2e uses :6166, the installed walkthrough :6163); lying about the port in the
  // connection chip would misdirect any debugging session.
