...
// Suspense). JS-catchable render failures show a local fallback instead of
// white-screening the tree, and the failed tab is blocklisted
// (panelPersistGuard) so the next
...
export default class PanelErrorBoundary extends Component<PanelErrorBoundaryProps, PanelErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo) {
    ...
    // the console line keeps the real error available to diagnostic logs.
