 ...
 *  server so the ui.screenshot verb can fail actionably. A raw html-to-image
 *  rejection can stringify to "[object Event]",
 ...
 * the error names the culprit resource. Exported for unit tests.
 */
