 ...
 *
 * Deciding the shape from the chosen output folder prevents lossy conversion:
 * outside-project exports need an exact absolute route, while project exports
 * remain portable through their relative route. The server refuses ambiguous
 * requests rather than selecting a same-named file.
 *
